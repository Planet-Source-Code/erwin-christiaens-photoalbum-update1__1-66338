...
Public Property Get Underlined() As Boolean
  Underlined = UserControl.FontUnderline
  'Underlined = txt.FontUnderline
End Property

Public Property Let Underlined(new_value As Boolean)
  UserControl.FontUnderline = new_value
  lbl.FontUnderline = new_value
  PropertyChanged "Underlined"
End Property

Public Property Get Bold() As Boolean
  Bold = UserControl.FontBold
  'Bold = lbl.FontBold
End Property

Public Property Let Bold(new_value As Boolean)
  UserControl.FontBold = new_value
  lbl.FontBold = new_value
  PropertyChanged "Bold"
End Property

Public Property Get Italic() As Boolean
  Italic = UserControl.FontItalic
  'Italic = lbl.FontBold
End Property

Public Property Let Italic(new_value As Boolean)
  UserControl.FontItalic = new_value
  lbl.FontItalic = new_value
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    B = PropBag.ReadProperty("Bold", 0)
    UL = PropBag.ReadProperty("Underlined", 0)
    It = PropBag.ReadProperty("Italic", 0)
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    PropBag.WriteProperty "Underlined", UL 'UserControl.FontUnderline, False
    PropBag.WriteProperty "Bold", B 'UserControl.FontBold, False
    PropBag.WriteProperty "Italic", It 'UserControl.FontItalic, False
